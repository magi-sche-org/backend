...
func NewUserUsecase(ur repository.UserRepository, oar repository.OauthRepository, er repository.EventRepository, uv validator.UserValidator, gs service.OauthCalendarService) UserUsecase {
	return &userUsecase{
		ur:  ur,
		oar: oar,
		er:  er,
